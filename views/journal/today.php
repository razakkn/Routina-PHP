...
<div class="routina-wrap">
    <div class="routina-header">
       <div>
           <div class="routina-title">Journal Today</div>
           <div class="routina-sub">Entries for <?php echo htmlspecialchars($date); ?></div>
       </div>
    </div>

    <div class="card" style="grid-column: span 2;">
        <div class="card-kicker">Today's Entries</div>
        <?php if (empty($entries)): ?>
            <div class="text-muted py-4 text-center">No entries for today yet.</div>
        <?php else: ?>
